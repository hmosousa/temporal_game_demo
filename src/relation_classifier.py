...
class RandomRelationClassifier:
    def __init__(self):
        pass

    def score(self, text: str, relations) -> str:
        scores = [random.uniform(0.5, 1.0) for _ in relations]
        return scores


class GuidedRelationClassifier:
    def __init__(self):
        self.pipeline = transformers.pipeline(
            "text-classification", model="hugosousa/smol-135-ac-a4eaad65"
        )
